...
## Corpus Check
- 17 files · ~9,093,414 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 302 nodes · 550 edges · 12 communities detected
...
4. `read_lidar` - 20 edges
5. `Dates` - 19 edges
6. `chunks` - 18 edges
7. `stare` - 14 edges
8. `NoaaDas` - 14 edges
9. `extract_sync_window()` - 11 edges
10. `coarse_and_fine_lag()` - 11 edges
...
Cohesion: 0.09
Nodes (21): compute_hmix_for_matrix(), extract_epsilon_and_meta(), hmix_first_crossing(), is_valid_eps(), list_epsilon_files(), main(), process_file(), rng_height() (+13 more)
...
- **Why does `Dates` connect `Community 2` to `Community 0`, `Community 1`, `Community 3`, `Community 4`, `Community 5`, `Community 6`, `Community 7`, `Community 8`, `Community 9`, `Community 10`?**
...
- **Why does `Statistics` connect `Community 3` to `Community 0`, `Community 1`, `Community 2`, `Community 6`, `Community 8`, `Community 11`?**
